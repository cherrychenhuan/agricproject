    ...
    <el-tabs type="border-card" style="margin-left:-5px;margin-top:-5px;" @tab-change="changeTab">
      <el-tab-pane label="待审核" style="border-bottom:0;">
        ...
        <el-table id="cropcategoryTable" style="height:71.7vh;" @select="setSelectRows" :row-key="getRowKey"
          ...
          <el-table-column align="center" :show-overflow-tooltip="true" prop="realname" label="真实姓名" width="120" />
          <el-table-column align="center" prop="idnumber" :show-overflow-tooltip="true" label="身份证号" width="150" />
        ...
        <el-dialog :show-close="false" class="myDialog" :visible.sync="dialogVisible" align-center
          ...
          <el-form ref="dialogForm" :show-message="false" :rules="rules" class="dialog-form" @submit.native.prevent=""
            ...
            <el-row :gutter="15">
              ...
              <el-col :span="12">
                ...
                <el-form-item :label="'真实姓名:'">
                  <el-input disabled placeholder="" v-model="dataForm1.realname" />
                </el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="15">
              <el-col :span="12">
                <el-form-item :label="'身份证号:'">
                  <el-input disabled placeholder="" v-model="dataForm1.idnumber" />
                </el-form-item>
              </el-col>
            ...
            <el-row style="background-color:#e1f3d8;margin-bottom:15px;">
              <el-col :span="12">
                <div style="text-align:center;color:#009237;">
                  <span class="demonstration">身份证正面</span>
                  <el-image :preview-src-list="['http://localhost:8080/verifyid/19816893357正面.png?v=1']"
                    style="width: 244px; height: 154px" :src="'http://localhost:8080/verifyid/19816893357正面.png?v=1'"
                    :fit="fit" />
                </div>
              </el-col>
              <el-col :span="12">
                <div style="text-align:center;color:#009237;">
                  ...
                  <el-image style="width: 244px; height: 154px"
                    :src="'http://localhost:8080/verifyid/19816893357正面.png?v=1'" :fit="fit" />
                </div>
              </el-col>
            </el-row>
...
import { filterVerifyIDDataService, idVerifyListService, addUserService, updateUserService, deleteUserService, updateVerifyIDDataService, userFilterService } from '@/api/admin.js'
...
const filterVerifyIDData = async () => {
  if (idtime1.value != '' && idtime2.value != '') {
    let result = await filterVerifyIDDataService({
...
const getVerifyList1 = async (flag, row) => {
  try {
    ...
    let result = await idVerifyListService(params);
...
const passBtn1 = async () => {
  ...
  let result = await updateVerifyIDDataService(params)
