    ...
    <el-row>
            ...
            <el-row>
                ...
                <el-card class="argomCardClass" style="max-width: 480px" shadow="never">
                  ...
                  <template #footer>
                    <el-button-group class="ml-4" style="float:right;">
                      <el-button @click="addTiRow" size="small" :disabled="true" type="primary" :icon="Plus">新增</el-button>
                      <el-button @click="handleDeleteTiBtn" :disabled="true" size="small" type="danger" :icon="Delete">删除</el-button>
                    </el-button-group>
                  </template>
                </el-card>
              </el-col>
              <el-col :span="12">
                <el-card class="argomCardClass" style="max-width: 480px" shadow="never">
                  ...
                  <template #footer>
                    <el-button-group class="ml-4" style="float:right;">
                      <el-button @click="addSiRow" size="small" type="primary" :disabled="true" :icon="Plus">新增</el-button>
                      <el-button @click="handleDeleteSiBtn" size="small" type="danger" :disabled="true" :icon="Delete">删除</el-button>
                    </el-button-group>
                  </template>
                </el-card>
              </el-col>
      ...
      <el-col :span="19" v-else>
        ...
        <div style="padding-left:5px;padding-top:10px;">
          ...
          <el-button size="small" type="warning" @click="addCropCalendar">新增推荐计划</el-button>
        </div>
      </el-col>
    </el-row>
  </div>
...
const getData = async () => {
  //先获取第一层数据
  let result1 = await getArgoService({ flag: 1 })
  for (let i = 0; i < result1.data.length; i++) {
    result1.data[i].id = result1.data[i].mid
    result1.data[i].label = result1.data[i].managename.split('-')[1] + result1.data[i].managename.split('-')[2]
  }
