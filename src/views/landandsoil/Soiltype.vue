<template>
  <div>
    <el-row>
      ...
      <el-col :span="17">
        <div
          style="background-color:aliceblue;color:black;margin-top:-5px;margin-left:-5px;border-bottom:2px solid #e6e6e6b2; font-size:13px;line-height:50px;height:43px;text-align: center;">
          <el-text>土壤类型分布图</el-text>
        </div>
        <div>
          <img src="../../assets/soil.png" style="width:100%;height:550px;" />
          <div style="position:absolute;bottom:50px;right:50px;"><img style="width:130px;"
